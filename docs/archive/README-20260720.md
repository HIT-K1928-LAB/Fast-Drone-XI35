...
<img src="../../docs/assets/xi35悬停图2.jpg" width = 32% height = 32% div align=left />
<img src="../../docs/assets/八架xi35.jpg" width = 34% height = 34% div align=center />
...
<img src="../../docs/assets/avoid.gif" width = 50% height = 50% div align=center />
  
- 双机通信协同
<img src="../../docs/assets/双机通信协同.gif" width = 50% height = 50% div align=center />

- 预设航迹，搜索特定数字标识，正确识别后并降落
<img src="../../docs/assets/搜索识别降落.gif" width = 40% height = 40% div align=center />
  
- 自主跟随墙面飞行
<img src="../../docs/assets/跟墙飞行成功2长距离6点-2025-01-17-00-16-39_output.gif" width = 50% height = 50% div align=left />
<img src="../../docs/assets/走廊跟墙第三视角3.gif" width = 50% height = 50% div align=center />
...
<p align="center">
  <img src="../../docs/assets/image.png" width="50%">
</p>

- 点击左侧的远程资源管理器，点击“+”新建远程，输入宿主机的用户名和 IP。

<p align="center">
  <img src="../../docs/assets/image-1.png" width="40%">
</p>

- 登录成功后即可编辑代码，修改会同步到容器中的 `/root/Fast-Drone-XI35`。

<p align="center">
  <img src="../../docs/assets/image-2.png" width="40%">
</p>
...
<p align="center">
  <img src="../../docs/assets/plotjuggler-1.png" width="90%">
</p>

<p align="center">
  <img src="../../docs/assets/plotjuggler-2.png" width="90%">
</p>
