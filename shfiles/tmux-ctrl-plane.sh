...
if [ $? != 0 ]; then
    ...
    tmux send-keys -t $SESH:rspx4 "export ROS_IP=$ROS_IP" C-m
    ...
    tmux send-keys -t $SESH:kffusion "export ROS_IP=$ROS_IP" C-m
    ...
    tmux send-keys -t $SESH:px4ctrl "export ROS_IP=$ROS_IP" C-m
    ...
    tmux send-keys -t $SESH:egoplanner "export ROS_IP=$ROS_IP" C-m
    ...
    tmux send-keys -t $SESH:searchplan "export ROS_IP=$ROS_IP" C-m
