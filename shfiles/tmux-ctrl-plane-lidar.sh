...
ROS_HOSTNAME="192.168.31.53"
ROS_MASTER_URI="http://192.168.31.33:11311"
...
if [ $? != 0 ]; then
    ...
    tmux send-keys -t $SESH:rspx4 "sh ~/Fast-Drone-XI35/shfiles/rspx4_lio.sh"
    ...
    tmux send-keys -t $SESH:egoplanner "roslaunch ego_planner single_run_in_exp_lio.launch"
